...
#pragma region Window init
	...
	DisplayWin32 WinDisplay(L"My3DApp", GetModuleHandle(nullptr), 800, 800);
...
#pragma endregion Window init
	...
	//swapDesc.BufferDesc.Width = WinDisplay.clientWidth;
	//swapDesc.BufferDesc.Height = WinDisplay.clientHeight;
	...
	//swapDesc.OutputWindow = WinDisplay.hWindow;
	...
	//	viewport.Width = static_cast<float>(WinDisplay.clientWidth);
	//	viewport.Height = static_cast<float>(WinDisplay.clientHeight);
	//	viewport.TopLeftX = 0;
	//	viewport.TopLeftY = 0;
	//	viewport.MinDepth = 0;
	...
	//		SetWindowText(WinDisplay.hWindow, text);
